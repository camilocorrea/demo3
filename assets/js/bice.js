...
$(document).ready(function () {
  ...
  if (document.documentMode || /Edge/.test(navigator.userAgent)) {
    ...
    var test = (((25000000-7000000) * 100) / 73000000);

    $( ".sliderPrecio input" ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+test +'%, #DEDECF ' + test + '%, #DEDECF 100%)' );

    $( '.sliderPrecio input' ).on( 'input', function( ) {

      var test = (((this.value-7000000) * 100) / 73000000);

      $( this ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+test +'%, #DEDECF ' + test + '%, #DEDECF 100%)' );


    } );

    var test2 = (((142500-20000) * 100) / 1980000)
    $( ".sliderCuota input" ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+test2 +'%, #DEDECF ' + test2 + '%, #DEDECF 100%)' );

    $( '.sliderCuota input' ).on( 'input', function( ) {

      var test2 = (((this.value-20000) * 100) / 1980000)

      $( this ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+test2 +'%, #DEDECF ' + test2+ '%, #DEDECF 100%)' );
...
function cssIsolatedRangeCuota(inputSlider){
  ...
  if (document.documentMode || /Edge/.test(navigator.userAgent)) {
    ...
    var slider2 = (((sliderID2-20000) * 100) / 1980000);
    //$( ".sliderPrecio input" ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+slider2 +'%, #DEDECF ' + slider2 + '%, #DEDECF 100%)' );
    $( ".sliderCuota input" ).css( 'background', 'linear-gradient(to right, #AAB00A 0%, #AAB00A '+slider2 +'%, #DEDECF ' + slider2 + '%, #DEDECF 100%)' );
  }
